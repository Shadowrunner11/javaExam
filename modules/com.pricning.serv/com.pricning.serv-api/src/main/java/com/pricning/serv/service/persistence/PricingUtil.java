...
/**
 * The persistence utility for the pricing service. This utility wraps <code>com.pricning.serv.service.persistence.impl.PricingPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PricingUtil {
	 ...
	 */
	public static Map<Serializable, Pricing> fetchByPrimaryKeys(
	 ...
	 */
	public static Pricing update(Pricing pricing) {
	 ...
	 */
	public static Pricing update(
		Pricing pricing, ServiceContext serviceContext) {
	 ...
	 */
	public static List<Pricing> findByUuid(String uuid) {
	 ...
	 */
	public static List<Pricing> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Pricing> findByUuid(
	 ...
	 */
	public static Pricing findByUuid_First(
			String uuid, OrderByComparator<Pricing> orderByComparator)
		throws com.pricning.serv.exception.NoSuchPricingException {
	 ...
	 */
	public static Pricing fetchByUuid_First(
		String uuid, OrderByComparator<Pricing> orderByComparator) {
	 ...
	 * @throws NoSuchPricingException if a matching pricing could not be found
	 */
	public static Pricing findByUuid_Last(
			String uuid, OrderByComparator<Pricing> orderByComparator)
		throws com.pricning.serv.exception.NoSuchPricingException {
	 ...
	 */
	public static Pricing fetchByUuid_Last(
		String uuid, OrderByComparator<Pricing> orderByComparator) {
	 ...
	 */
	public static Pricing[] findByUuid_PrevAndNext(
	 ...
	 */
	public static void cacheResult(Pricing pricing) {
	 ...
	 */
	public static void cacheResult(List<Pricing> pricings) {
	 ...
	 */
	public static Pricing create(long id) {
	 ...
	 * @throws NoSuchPricingException if a pricing with the primary key could not be found
	 */
	public static Pricing remove(long id)
		throws com.pricning.serv.exception.NoSuchPricingException {

		return getPersistence().remove(id);
	}

	public static Pricing updateImpl(Pricing pricing) {
	 ...
	 * @throws NoSuchPricingException if a pricing with the primary key could not be found
	 */
	public static Pricing findByPrimaryKey(long id)
		throws com.pricning.serv.exception.NoSuchPricingException {
	 ...
	 */
	public static Pricing fetchByPrimaryKey(long id) {
	 ...
	 * @return the pricings
	 */
	public static List<Pricing> findAll() {
	 ...
	 */
	public static List<Pricing> findAll(int start, int end) {
	...
	private static volatile PricingPersistence _persistence;
