...
/**
 * Provides the local service interface for Pricing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PricingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PricingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.pricning.serv.service.impl.PricingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pricing local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PricingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Pricing createPricing(long id);
	...
	public Pricing deletePricing(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pricing fetchPricing(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Pricing getPricing(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Pricing> getPricings(int start, int end);
