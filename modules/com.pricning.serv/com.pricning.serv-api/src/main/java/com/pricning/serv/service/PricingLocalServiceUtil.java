 ...
 * <code>com.pricning.serv.service.impl.PricingLocalServiceImpl</code> and
...
public class PricingLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.pricning.serv.service.impl.PricingLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Pricing addPricing(Pricing pricing) {
	 ...
	 */
	public static Pricing createPricing(long id) {
		return getService().createPricing(id);
	}
	 ...
	 */
	public static Pricing deletePricing(long id) throws PortalException {
		return getService().deletePricing(id);
	}
	 ...
	 * @return the pricing that was removed
	 */
	public static Pricing deletePricing(Pricing pricing) {
	...
	public static Pricing fetchPricing(long id) {
		return getService().fetchPricing(id);
	}
	 ...
	 * @throws PortalException if a pricing with the primary key could not be found
	 */
	public static Pricing getPricing(long id) throws PortalException {
		return getService().getPricing(id);
	}
	 ...
	 */
	public static List<Pricing> getPricings(int start, int end) {
	 ...
	 */
	public static Pricing updatePricing(Pricing pricing) {
	...
	private static volatile PricingLocalService _service;
